...
const dictionaries = {
  en: {
    ...
    'video.errorBotCheck': 'YouTube asked for verification',
    'video.errorStaleCookies': 'Your YouTube cookies expired',
    'toast.staleCookiesDetected': 'Your YouTube cookies expired — re-export them following the guide in the Videos panel.',
    'video.configureCookies': 'Configure cookies',
    ...
    'cookies.hint': 'Paste the content of a cookies.txt exported from your browser to authenticate downloads.',
    'cookies.save': 'Save',
    'cookies.clear': 'Clear',
    'cookies.statusOn': 'configured',
    'cookies.statusOff': 'not configured',
    'cookies.guideTitle': 'How to get your cookies',
    'cookies.guideIntro': 'Follow these steps to export your YouTube cookies and paste them below.',
    'cookies.guideStep1': 'Install the browser extension "Get cookies.txt LOCALLY" (Chrome/Edge) or "cookies.txt" (Firefox).',
    'cookies.guideStep2': 'Sign in to youtube.com — ideally in a private window with a secondary account.',
    'cookies.guideStep3': 'In the same tab, go to youtube.com/robots.txt (this prevents YouTube from rotating the cookies you are about to export).',
    'cookies.guideStep4': 'Click the extension icon and choose Export/Copy.',
    'cookies.guideStep5': 'Paste the copied text into the cookies box and press Save.',
    'cookies.guideNote': 'Cookies expire — if downloads fail again later, export them once more.',
    'toast.cookiesCleared': 'Cookies cleared',
    'toast.cookiesSaveFailed': 'Failed to save cookies: {message}',
    'toast.cookiesEmpty': 'Paste the cookies first',
    'toast.cookiesSavedRetry': 'Cookies saved — try adding the video again',
    'toast.botCheckDetected': 'YouTube asked for verification. Configure cookies in the Videos panel.',
  ...
  es: {
    ...
    'video.errorBotCheck': 'YouTube pidió verificación',
    'video.errorStaleCookies': 'Tus cookies de YouTube expiraron',
    'toast.staleCookiesDetected': 'Tus cookies de YouTube expiraron — vuelve a exportarlas siguiendo la guía del panel de Videos.',
    'video.configureCookies': 'Configurar cookies',
    ...
    'cookies.title': 'Cookies de YouTube',
    'cookies.hint': 'Pega el contenido de un cookies.txt exportado desde tu navegador para autenticar las descargas.',
    'cookies.save': 'Guardar',
    'cookies.clear': 'Borrar',
    'cookies.statusOn': 'configuradas',
    'cookies.statusOff': 'no configuradas',
    'cookies.guideTitle': 'Cómo obtener tus cookies',
    'cookies.guideIntro': 'Sigue estos pasos para exportar tus cookies de YouTube y pegarlas abajo.',
    'cookies.guideStep1': 'Instala la extensión del navegador "Get cookies.txt LOCALLY" (Chrome/Edge) o "cookies.txt" (Firefox).',
    'cookies.guideStep2': 'Inicia sesión en youtube.com — idealmente en una ventana privada con una cuenta secundaria.',
    'cookies.guideStep3': 'En la misma pestaña, entra a youtube.com/robots.txt (esto evita que YouTube rote las cookies que vas a exportar).',
    'cookies.guideStep4': 'Haz clic en el ícono de la extensión y elige Export/Copy.',
    'cookies.guideStep5': 'Pega el texto copiado en el cuadro de cookies y presiona Guardar.',
    'cookies.guideNote': 'Las cookies expiran — si las descargas vuelven a fallar más adelante, expórtalas de nuevo.',
    'toast.cookiesCleared': 'Cookies eliminadas',
    'toast.cookiesSaveFailed': 'Error al guardar las cookies: {message}',
    'toast.cookiesEmpty': 'Primero pega las cookies',
    'toast.cookiesSavedRetry': 'Cookies guardadas — intenta agregar el video de nuevo',
    'toast.botCheckDetected': 'YouTube pidió verificación. Configura las cookies en el panel de Videos.',
